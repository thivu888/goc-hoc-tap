...
const Home = ({setoverlay,setUserConnect,setChatBoxShow,chatBoxShow,userConnect}) => {
    ...
    return (<>
            <div className="container-fluid">
                 <div className='row'>
                    <Sidebar/>
                    <Feed setoverlay={setoverlay} socket={socket.current}/>
                    <Rightbar setChatBoxShow={setChatBoxShow}  setUserConnect={setUserConnect} socket={socket.current}/>
                </div>
            </div>
